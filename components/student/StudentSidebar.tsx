...
import { LayoutDashboard, BookOpen, GraduationCap, User, LogOut, Sun, Moon, Home, Award, Clock } from "lucide-react"
  ...
  return (
    <div className="fixed left-0 top-0 h-full w-64 bg-white dark:bg-gray-800 shadow-lg border-r border-gray-200 dark:border-gray-700 z-40">
      ...
      <div className="p-6 border-b border-gray-200 dark:border-gray-700">
        ...
        <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">Student Portal</p>
      </div>
